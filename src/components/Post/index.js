        ...
        <div className="post">
            ...
            <div className="post__footer">
                <div className="post__likes">
                    {user ? likes.includes(user.uid) ? <button onClick={() => removeLike()} className="post__btn" aria-label="Dislike"><Icon.Heart color="red" size={16} /></button> : <button onClick={() => addLike()} className="post__btn" aria-label="Like"><Icon.Heart color="black" size={16} /></button> : <button onClick={() => setShowModal(true)} className="post__btn" aria-label="Like"><Icon.Heart color="black" size={16} /></button>}
                    {likes.length}
                </div>
                <div>
